<div wire:ignore.self class="modal fade" tabindex="-1" data-bs-backdrop="static" data-bs-keyboard="false"
    aria-labelledby="staticBackdropLabel" aria-hidden="true" id="add_modal_card">
    <div class="modal-dialog modal-dialog-centered modal-xl">
        <div class="modal-content">
            <div class="modal-header" style="justify-content: center;">

                <h5 class="modal-title" style="color:black">Create Card</h5>
            ...
            <form wire:submit.prevent="insertCard">
                <div class="modal-body">
                    ...
                    <input type="hidden" wire:ignore name="id_list" wire:model="id_list" value="" id="id_list">
                    <div class="form-group">
...
<script>
    document.addEventListener('livewire:load', function () {
        Livewire.on('createCard', ($response) => {
            $('#add_modal_card').modal('hide');
            if ($response == "success") {
                Swal.fire({
                    icon: 'success',
                    title: 'Your Card has been Add',
                    timer: 5000
                })
            } else {
                Swal.fire(
